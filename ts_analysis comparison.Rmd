...
This notebook is responsible for the comparative analysis of the Truth Social data set acquired from the work of Gerard, Botzer and Weininger (2023). The original data was not read into this notebook, due to it's size. The first analysis was ran on a VM and the results are submitted along this notebook.
...
## Data from the analysis of Truth Social

| Metric                       | Truth Social    |
| ------                       | ------------    |
| Order                        | 454459          |
| Size                         | 4002115         |
| Degree range                 | 0 - 29890       |
| Indegree range               | 0 - 1843        |
| Outdegree range              | 0 - 29550       |
| Components (weak/strong)     | 9589 / 452043   |
| Connection                   | Disconnected    |
| Edge connectivity            | 0               |
| Vertex connectivity          | 0               |
| Diameter                     | 9               |
| MPL                          | 3.274598        |
| Transitivity                 | 0.01046866      |
...
```{r}
ts_sample_order <- 454459
ts_sample_size <- 4002115
